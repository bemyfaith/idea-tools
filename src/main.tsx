...
function App() {
  ...
  return <div className="app-shell">
    <aside className="sidebar">
      ...
      {contextMenu && <div className="context-menu" style={{ left: contextMenu.x, top: contextMenu.y }} onClick={(e) => e.stopPropagation()}><button onClick={() => applyLibraryDuration(contextMenu.sourceId, 0.5)}>0.5 秒</button><button onClick={() => applyLibraryDuration(contextMenu.sourceId, 1)}>1 秒</button><button onClick={() => applyLibraryDuration(contextMenu.sourceId, 2)}>2 秒</button><button onClick={() => applyLibraryDuration(contextMenu.sourceId, 3)}>3 秒</button><button onClick={() => applyLibraryDuration(contextMenu.sourceId, 5)}>5 秒</button><button onClick={() => applyLibraryDuration(contextMenu.sourceId, 8)}>8 秒</button></div>}
    </aside>
