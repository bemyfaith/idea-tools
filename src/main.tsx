...
function App() {
  ...
  return <div className="app-shell">
    ...
    <aside className="sidebar">
      ...
      {templateId === 'clean' && <div className="panel"><div className="panel-title">动画编辑</div><div className="settings-stack"><div className="setting-row"><label className="setting-label"><input type="checkbox" checked={deltaSearchEnabled} onChange={(e) => setDeltaSearchEnabled(e.target.checked)} />启用🔍动画</label></div><div className="setting-row"><div className="setting-label">🔍默认时长</div><div className="setting-inline"><input className="rank-size-input" type="number" min="0.5" step="0.1" value={deltaSearchDefaultDuration} onChange={(e) => setDeltaSearchDefaultDuration(e.target.value)} /><span>（秒）</span></div></div><div className="setting-row"><div className="setting-label">红金音效</div><div className="setting-inline"><span>≥</span><input className="rank-size-input" type="number" min="0.5" step="0.1" value={soundSettings.redgoldMin} onChange={(e) => setSoundSettings((prev) => ({ ...prev, redgoldMin: e.target.value }))} /></div></div><div className="setting-row"><div className="setting-label">紫蓝音效</div><div className="setting-inline"><input className="rank-size-input" type="number" min="0.1" step="0.1" value={soundSettings.greenMax} onChange={(e) => setSoundSettings((prev) => ({ ...prev, greenMax: e.target.value }))} /><span>-</span><input className="rank-size-input" type="number" min="0.1" step="0.1" value={soundSettings.redgoldMin} onChange={(e) => setSoundSettings((prev) => ({ ...prev, redgoldMin: e.target.value }))} /></div></div><div className="setting-row"><div className="setting-label">绿色音效</div><div className="setting-inline"><span>≤</span><input className="rank-size-input" type="number" min="0.1" step="0.1" value={soundSettings.greenMax} onChange={(e) => setSoundSettings((prev) => ({ ...prev, greenMax: e.target.value }))} /><span>（秒）</span></div></div></div></div>}
