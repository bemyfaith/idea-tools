...
function App() {
  ...
  return <div className="app-shell">
    <aside className="sidebar">
      <div className="brand"><div className="brand-badge"><Wrench size={22} strokeWidth={2.2} /></div><div><h1>有所梦_奇思妙想小工具</h1><p><a href="https://space.bilibili.com/227403410?spm_id_from=333.788.0.0" target="_blank" rel="noreferrer">从夯到拉锐评工具</a></p></div></div>
